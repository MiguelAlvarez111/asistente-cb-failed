...
class AIReasonCode(StrEnum):
    ...
    CHANGE_IN_TICKET = "CHANGE_IN_TICKET"
    DIRECT_CBCODE = "DIRECT_CBCODE"
    DIRECT_NPI = "DIRECT_NPI"
    PROVIDER_NAME_LOOKUP = "PROVIDER_NAME_LOOKUP"
    USAP_PENDING_CBCODE = "USAP_PENDING_CBCODE"
    REMOVE_FROM_TICKET = "REMOVE_FROM_TICKET"
    RN_INTERNAL_AUDIT = "RN_INTERNAL_AUDIT"
    FF_PROVIDER_OVERRIDE = "FF_PROVIDER_OVERRIDE"
    DICTIONARY_VALIDATION_FAILED = "DICTIONARY_VALIDATION_FAILED"
